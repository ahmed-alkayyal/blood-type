                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="social">
                            <div class="icons">
                                ...
                                <a href="{{$settings->email}}" class="whatsapp"><i class="fab fa-whatsapp"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="social col-md-4">
                            <div class="icons">
                                <a href="{{$settings->fb_link}}" class="facebook"><i class="fab fa-facebook-f"></i></a>
                                <a href="{{$settings->inst_link}}" class="instagram"><i class="fab fa-instagram"></i></a>
                                <a href="{{$settings->inst_link}}" class="twitter"><i class="fab fa-twitter"></i></a>
                                <a href="{{$settings->inst_link}}" class="whatsapp"><i class="fab fa-whatsapp"></i></a>
                            </div>
                        </div>
