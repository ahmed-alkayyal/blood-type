            ...
            <div id="slider" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item carousel-1 active">
                        <div class="container info" style="justify-content: left;">
                            <div class="col-lg-5">
                            ...
                            @foreach($posts as $post)
                                <div class="card">
                                    <div class="photo">
                                        ...
                                        <a href="{{url(route('posts.show',$post->id))}}" class="click">more</a>
                                        {{-- //href="article-details-ltr.html" --}}
                                    </div>
                        ...
                        @foreach($donationrequests as $donationrequest)
                            <div class="details">
                                <div class="blood-type">
                                    <h2 dir="ltr">{{$donationrequest->blood_type_id}}</h2>
                                </div>
                                <ul>
                                    <li><span>Patient name:</span> {{$donationrequest->patient_name}}</li>
                                    <li><span>Hospital:</span> {{$donationrequest->hospital_name}}</li>
                                    <li><span>City:</span> {{$donationrequest->client_id}}</li>
                                </ul>
