                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$record->name}}</td>
                                <td><a href="{{url(route('governorate.edit',$record->id))}}" class="btn btn-primary">edit</a></td>
                                <td>
                                    {!! Form::open([
                                ...
                                <td><a href="{{url(route('governorate.show',$record->id))}}" class="btn btn-primary">show cities {{$record->name}}</a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
